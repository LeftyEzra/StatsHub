"""
Django settings for my_basketball_website project.
...
SECRET_KEY = 'django-insecure-ewke8du39lgz8$+n+=6v8gotz9m_f4iv*alq1zka^ih153w(vo'
...
ROOT_URLCONF = 'my_basketball_website.urls'
...
WSGI_APPLICATION = 'my_basketball_website.wsgi.application'
